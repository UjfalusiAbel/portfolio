...
const Contact = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        setLoading(true);
        emailjs.send('service_78nsg9p','template_z3yme8m',
        {
            from_name:form.name,
            to_name:'Ujfalusi Abel',
            from_email:form.email,
            to_email:'abelujfalusi4@gmail.com',
            message:form.message
        }, 'htx294oNq2PMNZVwM').then(()=>{
            setLoading(false),
            ...
            <motion.div variants={slideIn('left', 'tween', 0.2, 1)}
                ...
                <form ref={formRef} onSubmit={handleSubmit}
                    ...
                    <label className='flex flex-col'>
                        ...
                        <textarea rows={8} name='message' value={form.message}
